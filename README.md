Nama: Mumtajul Fikri
NIM: 14012300133
Kelompok Kelas: 5D-KOM


1. Buat Database di Xampp MySql lalu Import database yang ada di folder
2. Buka di vscode folder Backend dan Frontend, untuk di backend diharap untuk mengaktifkan env
3. Run File app.py di Backend
4. Run yang berada di folder Frontend dengan flutter run
